...
| **Claude Desktop** | [![Download extension for Claude Desktop](https://img.shields.io/badge/Claude_Desktop-download_extension-d97757?logo=claude&logoColor=white)](https://github.com/arcadeai-labs/arcade/raw/main/clients/claude-desktop/arcade-gateway-hub.mcpb) |
...
- **Claude Desktop** — the button downloads
  ...
  ([alternatives](docs/install/claude-desktop.md))
